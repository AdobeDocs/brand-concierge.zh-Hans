---
title: 了解评估集
description: 了解评估集如何帮助您测试Brand Concierge是否正确应答、是否在范围之内，以及在上线之前安全地处理棘手的问题。
...
评估可告知您Adobe Brand Concierge是否正确回答、是否在范围之内以及是否安全地处理复杂的问题。 本视频介绍了三种评估类型 — 功能、超出范围和保护 — 并演示了如何构建评估集、运行评估集以及在上线之前查看标记的结果。
